...
?>
  <div class="container">
    <div class="row justify-content-md-center">
      ...
      <hr>
      <h2 class="h2 mb-3 font-weight-normal">SAOG-SE/BSB</h2>      
      <h3 class="h3 mb-3 font-weight-normal">Sistema de Apoio às Atividades Operacionais da GEOPE</h3>
      <br>
      <hr>
      <h3 class="h3 mb-3 font-weight-normal">Inscrições Encerradas</h3>
      <hr>
