...
?>
	...
	<div class="container">
		...
		$plantao->listarPlantaoCancelado();
...
<div class="modal fade" id="modalReativar" tabindex="-1" role="dialog" aria-labelledby="modalReativarTitle" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h3 class="modal-title" id="modalReativarLongTitle">Confirmar Reativação</h3>
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		      </div>
		      <div class="modal-body">
		        <h3>Deseja confirmar a reativação deste plantão?</h3>
	  				
				</div>
	        
		      <div class="modal-footer">		      	
		      	<button id="reativar_plantao" type="button" class="btn btn-success" onclick="reativarPlantao();">Confirmar</button>
		        <button type="button" class="btn btn-warning" data-dismiss="modal">Cancelar</button>		        
		      </div>
		    </div>
		  </div>
