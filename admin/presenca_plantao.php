...
<table class="table table-striped table-responsive-lg text-center">
  <thead>
    <tr>
      ...
      <th class="text-center" scope="col" colspan="2">Presença</th>
      <!--
  ...
  <tbody>
  	<?php
  		...
  		$plantao->verInscritosPassado($id_plantao);
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">            
            <button id="btn_confirmar_presenca" type="button" class="btn btn-success" onclick="registrarPresenca();">Confirmar</button>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header bg-danger">
            <h3 class="modal-title text-white" id="modalPresencaLongTitle">Confirmar Falta</h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body  bg-danger">
            <h3 class="text-center text-white">Deseja confirmar a FALTA do funcionário?</h3>                  
        </div>
            
          <div class="modal-footer bg-danger">            
            <button id="btn_confirmar_falta" type="button" class="btn btn-success" onclick="registrarFalta();">Confirmar</button>
            <button type="button" class="btn btn-warning" data-dismiss="modal">Cancelar</button>            
          </div>
        </div>
      </div>
